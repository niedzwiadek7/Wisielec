...
--
-- Host: 127.0.0.1
-- Czas generowania: 25 Cze 2020, 10:47
...
(41, 'ABECADEŁKo', 0),
(42, 'ALFANÓMERCZY', 0),
(43, 'ABECADŁO Z piecyka spadło', 0),
(44, 'MORDECZKO MORDÓniu', 0),
(45, 'Nowiutkie hasło', 0),
(46, 'Damian to debil', 1);
...
(11, 'nazwa', '$2y$10$wzrjQBDri0v01Le1TynokOzP4Q97OiDYtEDPRZ31JDVllA9cQfBSW', 'email@email.com', 15, 1),
...
(22, 'meee123', '$2y$10$rofx4k.w6b9Irkh45Co/4OntmT9wN91htuTRX2GiK8RSilFx6arq2', 'meee123@gmail.com', 0, 0);
...
--
ALTER TABLE `pytania`
  MODIFY `id_pyt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
